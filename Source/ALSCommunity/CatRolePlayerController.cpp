...
#include "CatRolePlayerController.h"
#include "EnhancedInputSubsystems.h"
#include "EnhancedInputComponent.h"
#include "InputMappingContext.h"
#include "CatRoleBaseCharacter.h"

void ACatRolePlayerController::OnPossess(APawn* NewPawn)
{
...
void ACatRolePlayerController::SetupInputComponent()
{
...
void ACatRolePlayerController::BindActions(UInputMappingContext* Context)
{	
	if (Context)
	{
...
void ACatRolePlayerController::SetupInputs()
{
...
void ACatRolePlayerController::ForwardMovementAction(const FInputActionValue& Value)
{
	if (PossessedCharacter)
	{
